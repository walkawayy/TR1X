...
#define Output_CalculateStaticLight ((void __cdecl (*)(int16_t adder))0x00451480)
#define Output_CalculateStaticMeshLight ((void __cdecl (*)(int32_t x, int32_t y, int32_t z, int32_t shade_1, int32_t shade_2, ROOM *room))0x004514C0)
