...
static void M_DecompEffects(const bool enable)
{
    ...
    INJECT(enable, 0x0041CF70, FX_FloorShake);
    INJECT(enable, 0x0041D010, FX_LaraNormal);
    INJECT(enable, 0x0041D050, FX_Boiler);
    ...
    INJECT(enable, 0x0041D190, FX_Piston);
    INJECT(enable, 0x0041D1B0, FX_Curtain);
    ...
    INJECT(enable, 0x0041D7A0, FX_LaraDrawRightGun);
    ...
    INJECT(enable, 0x0041D9C0, FX_InvisibilityOn);
    INJECT(enable, 0x0041D9D0, FX_InvisibilityOff);
    ...
    INJECT(enable, 0x0041DA70, FX_AssaultReset);
    INJECT(enable, 0x0041DA90, FX_AssaultFinished);
...
static void M_Objects(const bool enable)
{
    ...
    INJECT(enable, 0x0043FF60, TeethTrap_Bite);
    ...
    INJECT(enable, 0x00442110, Spikes_Collision);
    ...
    INJECT(enable, 0x00442AE0, DartEffect_Control);
