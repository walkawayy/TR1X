...
static void M_InitText(void)
{
    ...
    Text_AddOutline(g_SoundText[0], 1, INV_COLOR_ORANGE, 0);
...
void __cdecl Option_Sound(INVENTORY_ITEM *const item)
{
    ...
    if (g_InputDB.forward && g_SoundOptionLine > 0) {
        ...
        Text_AddBackground(
            ...
            0);
        Text_AddOutline(g_SoundText[g_SoundOptionLine], 1, INV_COLOR_ORANGE, 0);
    }
